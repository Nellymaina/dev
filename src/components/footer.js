...
<p className='w-[100vw]  md:w-auto md:block hidden text-neonGreen '>© 2024 Nelly Maina. All rights reserved.</p>
  ...
  <p className="w-[100vw] md:w-auto md:block flex text-red-600 justify-center mt-2">Email: <a className="text-neonGreen" href="mailto:nellymaina095@gmail.com" >nellymaina095@gmail.com</a></p>
  ...
  <p className='w-[100vw]  md:hidden flex text-neonGreen justify-center mt-4'>© 2024 Nelly Maina. All rights reserved.</p>
