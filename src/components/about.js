...
export default function about(){
    return(
      ...
      <h2 className='sm:text-2xl text-xl  inset-0 sm:w-[25vw] w-[50vw] font-bold flex justify-center underline text-neonGreen'>About Me</h2>

            <div className=' relative min-h-80vh md:flex '>

<img src={image} alt='' className='w-[40vw] sm:w-[30vw] md:w-[25vw] md:mt-8 mt-2 md:ml-4  '/>
...
<p className=' text-[16px] text-white sm:text-[18px]  mr-4 ml-4 mt-[50px] mb-[50px] '>I’m a front-end developer with 6 months of hands-on experience, primarily working as a freelancer on Upwork. During this time, I’ve collaborated with clients to create user-focused, responsive websites that meet their unique needs. My freelance projects have honed my ability to manage deadlines, communicate effectively, and deliver high-quality work.</p>
</div>
