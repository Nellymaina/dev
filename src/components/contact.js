...
function handleForm(e){
    ...
    return(
        <div className="h-auto mt-[16vh] mb-[10vh] ">
            ...
            <h2 className="sm:text-2xl text-xl md:text-3xl inset-0 sm:w-[25vw] w-[50vw] font-bold flex justify-center underline text-neonGreen">Contact</h2>
            ...
            <form className=" mt-4 bg-transparent relative ">
                ...
                <textarea onChange={handleForm} name="message" value={Form.message} placeholder='Message' className="shadow-md shadow-black rounded-md ml-2 md:ml-0 absolute w-[80vw] lg:w-[40vw] landscape:min-h-[60vh] min-h-[40vh] mb-6 border-black border"></textarea>
